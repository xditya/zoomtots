...
def load_animation_frames(character="doraemon"):
    ...
    talk_frames = get_sorted_frames(
        os.path.join("images", character, "talk", talk_folder), "talk-*.png"
    )
    left_walk_frames = get_sorted_frames(
        os.path.join("images", character, "walk", "left"), "walk-*.png"
    )
    right_walk_frames = get_sorted_frames(
        os.path.join("images", character, "walk", "right"), "walk-*.png"
    )
